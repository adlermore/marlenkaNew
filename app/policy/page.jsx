    ...
    <div className='!mt-[120px] !min-h-[100vh] mobile:!mt-[150px]'>
      ...
      <div className="privacy_content custom_container">
        <div className="py-[40px]">
          <p className="text-stone-800 text-stone-800 tracking-wider">
            <span className="text-xl">
              <br />
              At Marlenka.us, accessible from <a target="_blank" href="https://marlenka.us/">https://marlenka.us</a> one of our
              ...
              and recorded by Marlenka.us and how we use it.
              <br />
              <br />
              ...
              that they shared and/or collect in Marlenka.us. This policy is not
            ...
            <span className="text-xl">
              <br />
              Marlenka.us follows a standard procedure of using log files. These
            ...
            <span className="text-xl">
              <br />
              Like any other website, Marlenka.us uses "cookies". These cookies
            ...
            <span className="text-xl">
              ...
              the advertising partners of Marlenka.us.
              <br />
              Third-party ad servers or ad networks uses technologies like
              cookies, JavaScript, or Web Beacons that are used in their
              respective advertisements and links that appear on Marlenka.us,
              ...
              <br />
              <br />
              Note that Marlenka.us has no access to or control over these
            ...
            <span className="text-xl">
              <br />
              Marlenka.us's Privacy Policy does not apply to other advertisers
            ...
            <span className="text-xl">
              ...
              activity.
              <br />
              Marlenka.us does not knowingly collect any Personal Identifiable
