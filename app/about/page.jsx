    ...
    <div className=' !mt-[120px] !min-h-[100vh] mobile:!mt-[150px]'>
      ...
      <div className='custom_container'>
        ...
        <div className='pt-[40px]'>
          ...
          <div className='grid grid-cols-3 gap-[45px] mt-[60px]'>
            <div>
              <div className='relative h-[288px] rounded-[10px] overflow-hidden'>
                <Image 
                  src={about5}
                  alt='about-5'
                  fill
              ...
              <div className='text-xl mt-[25px] font-medium'>Aznavour Foundation Award</div>
            </div>
            <div>
              <div className='relative h-[288px] rounded-[10px] overflow-hidden'>
                <Image 
              ...
              <div className='text-xl mt-[25px] font-medium'>Award from the President of the Czech Republic</div>
            </div>
            <div>
              <div className='relative h-[288px] rounded-[10px] overflow-hidden'>
                <Image 
              ...
              <div className='text-xl mt-[25px] font-medium'>MARLENKA wins two more awards</div>
            </div>
          </div>
